...
/** Contacto y datos legales — editar aquí para actualizar los términos. */
export const TERMS_LAST_UPDATED = "15 de agosto de 2026";

export const TERMS_EMAIL = ABOUT_EMAIL;
export const TERMS_EMAIL_HREF = ABOUT_EMAIL_HREF;

export const TERMS_WHATSAPP_DISPLAY = ABOUT_WHATSAPP_DISPLAY;
export const TERMS_WHATSAPP_HREF = ABOUT_WHATSAPP_HREF;
...
export const TERMS_CONTACT: TermsContactInfo = {
  email: TERMS_EMAIL,
  emailHref: TERMS_EMAIL_HREF,
  whatsappDisplay: TERMS_WHATSAPP_DISPLAY,
  whatsappHref: TERMS_WHATSAPP_HREF,
